...
namespace API.Data.Migrations
{
    ...
    [Migration("20260909170457_AddImportCsv")]
    partial class AddImportCsv
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "import_status", new[] { "pending", "committed", "failed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "notification_type", new[] { "recurring_transaction_generated", "budget_threshold_reached" });
            ...
            modelBuilder.Entity("API.Entities.ImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("API.Entities.RecurringTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("API.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("API.Entities.ImportBatch", "ImportBatch")
                        .WithMany("Transactions")
                        .HasForeignKey("ImportBatchId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("API.Entities.RecurringTransaction", "RecurringTransaction")
                        .WithMany("Transactions")
